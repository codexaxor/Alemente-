...
<body>
	...
	if ($sort==1) {
		$query = "select * from item_information  where Catagory=3 order by Price ASC" ;
	} else if ($sort==2) {
		$query = "select * from item_information where Catagory=3 order by Price DESC" ;
	} else if($sort==0) {
		$query = "select * from item_information where Catagory=3 order by Id ASC" ;
	}
